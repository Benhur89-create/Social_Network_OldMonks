...
// Code to give privilege post delete function to admins.
            ...
            echo "
                <div class='row'>
                    ...
                    <div class='col-sm-6' id='posts'>
                        ...
                        <a href='single.php?post_id=$post_id' style='float:right;'>
                        <button class='btn btn-info'>Comment</button>
                        <a href='functions/delete_post_admin.php?post_id=$post_id' style='float: right;'><button class='btn btn-danger'>delete</button></a><br><br><br>
                        </a><br>
                    </div>
                    <div class='col-sm-3'>
                    </div>
